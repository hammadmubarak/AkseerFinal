...
//                startActivity(new Intent(NewsInsideActivity5.this, AdditionDeletion17.class));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView txt= (TextView) findViewById(R.id.readMore); //txt is object of TextView
        if (getIntent().getStringExtra("readMoreLink").equals("null")) {
            ...
            txt.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                        ...
                        browserIntent.setData(Uri.parse(getIntent().getStringExtra("readMoreLink")));
        ...
        ImageView img2 = (ImageView)findViewById(R.id.postImage2);
       ...
       impact.setText(getIntent().getStringExtra("impact"));
        ...
        else if(impact.getText().equals("NEGATIVE")){
        ...
        Picasso.with(this).load(getIntent().getStringExtra("list_post_image2")).into(img2);
